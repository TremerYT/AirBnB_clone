...
class TestBaseModel_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        basemodel = BaseModel()
        basemodel.id = "123456"
        basemodel.created_at = basemodel.updated_at = date_time
        basemodel_string = basemodel.__str__()
        self.assertIn("[BaseModel] (123456)", basemodel_string)
        self.assertIn("'id': '123456'", basemodel_string)
        self.assertIn("'created_at': " + date_rep, basemodel_string)
        self.assertIn("'updated_at': " + date_rep, basemodel_string)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        basemodel = BaseModel(id="345", created_at=date_time_iso, updated_at=date_time_iso)
        self.assertEqual(basemodel.id, "345")
        self.assertEqual(basemodel.created_at, date_time)
        self.assertEqual(basemodel.updated_at, date_time)
